            ...
            <div class="public-user-block block">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4 d-flex align-items-center">
                        ...
                        <div class="avatar"> <img src="adminpanel/img/avatar-1.jpg" alt="..." class="img-fluid">
                        </div><a href="#" class="name"><strong class="d-block">Tomas Hecktor</strong><span
            ...
            <div class="public-user-block block">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4 d-flex align-items-center">
                        ...
                        <div class="avatar"> <img src="adminpanel/img/avatar-2.jpg" alt="..." class="img-fluid">
            ...
            <div class="public-user-block block">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4 d-flex align-items-center">
                        ...
                        <div class="avatar"> <img src="adminpanel/img/avatar-6.jpg" alt="..." class="img-fluid">
                        </div><a href="#" class="name"><strong class="d-block">Arther Kooper</strong><span
